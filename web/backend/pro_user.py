...
SERVICE_CONF = {
    ...
    'chromecache': {'name': '仿真缓存管理', 'time': '手动', 'state': 'OFF', 'svg': '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-browser" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>\n                        <rect x="4" y="4" width="16" height="16" rx="1"></rect>\n                        <line x1="4" y1="8" x2="20" y2="8"></line>\n                        <line x1="8" y1="4" x2="8" y2="8"></line>\n                    </svg>', 'color': 'indigo', 'level': 1}
}
...
1. 如果曾经修改: 请去 https://raw.githubusercontent.com/TonyLiooo/nas-tools-sites/master/user.sites.bin 下载后还原
2. 如果从未修改: 请去 https://github.com/iMMIQ/nas-tools/issues 创建issue，并附上报错信息
----------------------------------------------------------------------------------------------------------
            """
            log.info(f"【User】\n{recovery_msg}")
            return {}, [], {}
